...
function get_random_port() {
	...
	else
	{
		...
		//first check for valid sip credentials
        $deviceName = $row['name'];
        ...
        if ($username && $password) {
            ...
            //Line 1
            $baseConfig = str_replace('{{A1-EXTENSION}}', $extension, $baseConfig);
            ...
            $customerConfig = str_replace('{{A1-DISPLAY-NAME}}', $deviceName, $customerConfig);
            $customerConfig = str_replace('{{A1-LABEL}}', $deviceName, $customerConfig);
            $customerConfig = str_replace('{{A1-USER-NAME}}', $username, $customerConfig);
            $customerConfig = str_replace('{{A1-AUTH-NAME}}', $username, $customerConfig);
            $customerConfig = str_replace('{{A1-PASSWORD}}', $password, $customerConfig);
            ...
            //Line 2
            $baseConfig = str_replace('{{A2-EXTENSION}}', $extension2, $baseConfig);
            ...
            $customerConfig = str_replace('{{A2-ENABLE}}', $a2_enable, $customerConfig);
            $customerConfig = str_replace('{{A2-DISPLAY-NAME}}', $deviceName2, $customerConfig);
            $customerConfig = str_replace('{{A2-LABEL}}', $deviceName2, $customerConfig);
            $customerConfig = str_replace('{{A2-USER-NAME}}', $username2, $customerConfig);
            $customerConfig = str_replace('{{A2-AUTH-NAME}}', $username2, $customerConfig);
            $customerConfig = str_replace('{{A2-PASSWORD}}', $password2, $customerConfig);


            //Line 3
            $baseConfig = str_replace('{{A3-EXTENSION}}', $extension3, $baseConfig);
            ...
            $customerConfig = str_replace('{{A3-ENABLE}}', $a3_enable, $customerConfig);
            $customerConfig = str_replace('{{A3-DISPLAY-NAME}}', $deviceName3, $customerConfig);
            $customerConfig = str_replace('{{A3-LABEL}}', $deviceName3, $customerConfig);
            $customerConfig = str_replace('{{A3-USER-NAME}}', $username3, $customerConfig);
            $customerConfig = str_replace('{{A3-AUTH-NAME}}', $username3, $customerConfig);
            $customerConfig = str_replace('{{A3-PASSWORD}}', $password3, $customerConfig);
            ...
            $customerConfig = str_replace('{{RANDOM_PORT}}', get_random_port(), $customerConfig);
            $customerConfig = str_replace('{{RANDOM_PORT2}}', get_random_port(), $customerConfig);
            $customerConfig = str_replace('{{RANDOM_PORT3}}', get_random_port(), $customerConfig);
            $customerConfig = str_replace('{{RANDOM_PORT4}}', get_random_port(), $customerConfig);
            $customerConfig = str_replace('{{RANDOM_PORT5}}', get_random_port(), $customerConfig);
            ...
            //Customer Config Replacements
            $customerConfig = str_replace('{{TRANSPORT-TYPE}}', $transport_type, $customerConfig);
            $customerConfig = str_replace('{{PRIMARY-HEADEND}}', $primaryHeadend, $customerConfig);
            $customerConfig = str_replace('{{REALM}}', $realm, $customerConfig);
            $customerConfig = str_replace('{{ACCOUNTID}}', $extension2, $customerConfig);
