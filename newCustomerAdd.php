<?php include 'inc_header.php';
	...
	if ($_REQUEST['action'] == 'createCustomerContact') //adding customer contact
	{
		
        $sql = "INSERT INTO tblContacts (customerID, locationID, firstname, lastname, email, phone1, phone2, notify, contactLabel) VALUES ({$_REQUEST['customerID']}, {$_REQUEST['locationID']}, '{$_REQUEST['firstName']}', '{$_REQUEST['lastName']}', '{$_REQUEST['email']}', '{$_REQUEST['phone1']}', '{$_REQUEST['phone2']}', {$_REQUEST['notify']}, '{$_REQUEST['contactNote']}')";
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>SimpleVoIP - Add Contact</title>
				...
				<div class="container">
					<div class="object-non-visible text-center" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
						...
						<div class="form-block center-block p-30 light-gray-bg border-clear">
							...
							<h2 class="title text-left">Add Contact</h2>
							<form action="newCustomerAdd.php" class="form-horizontal text-left" method="post">
							...
							<div class="form-group has-feedback">
								...
								<div class="form-group has-feedback">
									...
									<select name=locationID id=locationID required>
										<option value='0'>CUSTOMER CONTACT</option>
									</select>
									</div>
								</div>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea  class="form-control" id="contactNote" name="contactNote" rows=5 ></textarea>
                                    </div>
                                </div>
								...
								<div class="form-group">
									<div class="col-sm-offset-3 col-sm-8">
										...
										<button type="submit" class="btn btn-group btn-default btn-animated">Create Customer Contact <i class="fa fa-book"></i></button>
