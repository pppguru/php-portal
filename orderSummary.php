	...
	<body class="no-trans   ">
		...
		<section>
			...
			<div class="row">
				   ...
				   $sql = "SELECT * FROM vwOrders WHERE duedate <= '{$today}' AND (orderStatus = 'PENDING' OR orderStatus = 'PROVISIONED' OR orderStatus = 'IN PROGRESS') ORDER BY duedate";
				   ...
				   if(! $retval )
				   {
					...
					?>
                    <span>
                        <h2 style="display : inline-block; margin-right: 30px">Today's Orders </h2>
                    </span>
					...
					<?php
						...
						{
					        $duedate = substr($row['duedate'],0,10);
						?>
						<tr>
                            ...
                            ?>
                                    <td nowrap><?php echo $duedate;?></td>
                            <?php
                                }
                                else{
                            ?>
                                    <td nowrap style="color:red"><?php echo $duedate;?></td>
                            <?php
                                }
                            ?>
                ...
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM vwOrders WHERE duedate >= '{$today}' AND duedate < '{$weeklater}' AND (orderStatus = 'PENDING' OR orderStatus = 'PROVISIONED' OR orderStatus = 'IN PROGRESS') ORDER BY duedate";
                    ...
                    ?>
                    <h2>Orders in the next 7 days</h2>
